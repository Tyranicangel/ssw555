...
response+="People:\n"
response+="Id".ljust(10)+'Name'.ljust(30)+'Gender'.ljust(10)+'Birthday'.ljust(15)+'Alive'.ljust(10)+'Death'.ljust(15)+'Spouse'.ljust(20)+'Children\n'
...
response+='\n\n\nFamilies:\n'
response+="Id".ljust(10)+'Marriage'.ljust(15)+'Divorce'.ljust(15)+'Husband'.ljust(10)+'Wife'.ljust(10)+'Children\n'
for key in sorted(maindict['FAM'],key=lambda x:int(x.replace('@',"").replace('F',""))):
	...
	if 'HUSB' in maindict['FAM'][key]:
		response+=maindict['FAM'][key]['HUSB']['VAL'].ljust(10)
	else:
		response+='N/A'.ljust(10)
	if 'WIFE' in maindict['FAM'][key]:
		response+=maindict['FAM'][key]['WIFE']['VAL'].ljust(10)
	else:
		response+='N/A'.ljust(10)
